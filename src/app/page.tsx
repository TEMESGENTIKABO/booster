          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <div className="w-full min-h-64 md:min-h-72 relative bg-amber-50 flex items-center justify-center p-2">
                  <Image
                    src={event.image}
                    alt={event.title}
                    ...
                    priority={index < 2} // Optional: prioritize loading first few images
                  />
                </div>
